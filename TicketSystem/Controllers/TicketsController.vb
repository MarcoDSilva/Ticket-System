...
Namespace Controllers
    Public Class TicketsController
        ...
        Function Index() As ActionResult
            ...
            'Return View(LeituraDados("Select * from Ticket;"))

            Return View(LeituraDados("SELECT t.ID_ticket, tec.nome, sft.nome, cli.nome, prob.descricao, t.descricao, t.dataAbertura,
                                    t.dataFecho, t.tempoPrevisto, t.tempoTotal, est.descricao, prio.descricao,  
                                    t.ID_utilizador, ori.descricao,t.dat_hor

                                    FROM Ticket t,Tecnico tec, Software sft, Cliente cli, Problema prob, 
                                    Estado est, Prioridade prio,Origem ori
