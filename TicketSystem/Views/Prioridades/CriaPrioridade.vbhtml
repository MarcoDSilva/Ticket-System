...
@Using (Html.BeginForm())
    ...
    <div class="form-group">
        <p>
            ...
            @Html.TextBoxFor(Function(modelPrio) modelPrio.descricao)
        </p>
    </div>
    <input type="submit" value="Inserir Registo" class="btn btn-primary" />
    <button type="button" class="btn btn-default" onclick="location.href='@Url.Action("Index", "Prioridades")'">Voltar</button>
</div>
End Using
